...
abstract class AppLocalizations {
  ...
  /// No description provided for @emptyNameWarning.
  ///
  /// In en, this message translates to:
  /// **'Name cannot be empty'**
  String get emptyNameWarning;

  /// No description provided for @errorOnCreatingAccount.
  ///
  /// In en, this message translates to:
  /// **'An error occurred while trying to create your account'**
  String get errorOnCreatingAccount;

  /// No description provided for @enterNameToIdentifyYourself.
  ///
  /// In en, this message translates to:
  /// **'Enter a name to identify yourself:'**
  String get enterNameToIdentifyYourself;

  /// No description provided for @isThisYourFirstTimeHere.
  ///
  /// In en, this message translates to:
  /// **'Is this your first time here?'**
  String get isThisYourFirstTimeHere;
  ...
  /// No description provided for @yourCulturalLibrary.
  ///
  /// In en, this message translates to:
  /// **'Your cultural library'**
  String get yourCulturalLibrary;
}
